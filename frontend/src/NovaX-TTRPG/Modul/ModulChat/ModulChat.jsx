...
import PlaygroundBox from "../../Components/PlaygroundBox/PlaygroundBox";
import {Box} from "@mui/material";
import MuiChat from "../../Components/Chat/MuiChat";
...
const ModulChat = ({roomId, userId}) => {
    ...
    return (
        <Box sx={{width:'100%', height:'85vh', display: 'flex'}}>
            <Box sx={{width:'70%', height:'100%', display: 'flex', flexDirection: 'column'}}>
                <Box sx={{width:'100%', height: '85%'}}>
                    <PlaygroundBox imageUrl={"https://hatrabbits.com/wp-content/uploads/2017/01/random.jpg"} gridSize={50}/>
                </Box>
